...
def parse_args():
    ...
    parser.add_argument("--output-dir", default="outputs/runs/c100_concat_dinov2_blip2_same_params_mlp")
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_top1 > best_top1:
            best_top1 = val_top1
            checkpoint_path = checkpoint_dir / f"c100_concat_dinov2_blip2_same_params_mlp_{timestamp}_epoch_{epoch}.pth"
