...
DEFAULT_HIDDEN_DIM = 10197


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--data-dir", required=True, help="Path where CIFAR-10 is stored/downloaded")
    parser.add_argument("--output-dir", default="outputs/runs/c10_concat_dinov2_blip2_same_params_mlp")
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_top1 > best_top1:
            best_top1 = val_top1
            checkpoint_path = checkpoint_dir / f"c10_concat_dinov2_blip2_same_params_mlp_{timestamp}_epoch_{epoch}.pth"
