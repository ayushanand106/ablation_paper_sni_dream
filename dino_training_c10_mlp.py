...
Example:
    ...
    python dino_training_c10_mlp.py \
...
DEFAULT_HIDDEN_DIM = 10848


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--data-dir", required=True, help="Path where CIFAR-10 is stored/downloaded")
    parser.add_argument("--output-dir", default="outputs/runs/c10_dinov2_large_same_params_mlp")
...
class DINOv2LargeSameParamsMLP(nn.Module):
    def __init__(self, n_class=10, hidden_dim=DEFAULT_HIDDEN_DIM, model_name="facebook/dinov2-large", cache_dir=None):
        super().__init__()
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_top1 > best_top1:
            best_top1 = val_top1
            checkpoint_path = checkpoint_dir / f"c10_dinov2_large_same_params_mlp_{timestamp}_epoch_{epoch}.pth"
